...
const filteredBookings = !isLoadingData && bookings && (activeTab === "today"
    ? bookings.filter(booking => {
        ...
        return booking.OrderDate === getCurrentDate() && booking.confirmation === true && booking.vendorid === currentUser.uid;
    })
    : bookings.filter(booking => {
        // Filter by confirmation and vendorid
        return booking.confirmation === true && booking.vendorid === currentUser.uid;
    }));
