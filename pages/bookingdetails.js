...
{bookingData.roomType}</p>
</div>
<div class="w-full px-4 mb-4 md:w-1/4">
<p class="mb-2 text-sm font-medium leading-5 text-gray-800 dark:text-gray-400 ">
Room Price: </p>
<p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
{bookingData.roomprice}</p>
</div>
<div class="w-full px-4 mb-4 md:w-1/4">
<p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
Payment Done: </p>
...
<p class="text-base leading-4 text-gray-600 dark:text-gray-400">{bookingData.Propertyname}</p>
</div>
<div class="flex items-center justify-between w-full">
<p class="text-base leading-4 text-gray-800 dark:text-gray-400">Location
</p>
<p class="text-xs font-bold leading-4 text-gray-600 dark:text-gray-400">{bookingData.Location}</p>
</div>
{/* <div class="flex items-center justify-between w-full">
