...
const Signinsinup = () => {
  ...
  <button className="bg-white w-full md:w-80 py-2 px-4 text-black rounded focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 flex items-center justify-center">
    <img src="facebook1.svg" className="w-5 h-5 mr-2" alt="Facebook Logo" />
