...
const filteredBookings = !isLoadingData && bookings && (activeTab === "today"
    ? bookings.filter(booking => {
        // Filter by confirmation and deliveryboyid
        return booking.OrderDate === getCurrentDate() && booking.confirmation === true && booking.deliveryconfirmation === true && booking.deliveryboyid === currentUser.uid ;
    })
    : bookings.filter(booking => {
        // Filter by confirmation and deliveryboyid
        return booking.confirmation === true && booking.deliveryconfirmation === true && booking.deliveryboyid === currentUser.uid  ;
    }));
