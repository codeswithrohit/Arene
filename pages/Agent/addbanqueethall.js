...
{/* {userData && userData.userType === "Agent" ? (
                <div className="w-full">
                  ...
                  >
                    ...
                    <option value={userData.selectedBanqueethallType}>
                      {userData.selectedBanqueethallType}
                    </option>
                  </select>
                </div>
        ...
        <div className="w-full">
          ...
          >
            ...
            <option value="Banqueethall">Banqueethall</option>
          </select>
        </div>
          ...
          {Banqueethalldata
            .map((item, index) => (
              <div key={item.id} className="relative mx-auto w-full">
                <Link
                   href={`/Banqueethalldetail.html?id=${item.id}`}
