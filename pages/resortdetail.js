...
console.log(pgdetaildata)
                  ...
                  <div className="row align-items-center">
                    <div className="col-md-8">
                      <div className="listing-info-content">
                        ...
                        <h3 className="title">{pgdetaildata.ResortName}</h3>
                        <div className="listing-meta">
                          <ul>
                            <li>
                              <span>
                                <i className="ti-location-pin" />
                                {pgdetaildata.location}
                              </span>
                            </li>
                            <li>
                              <span>
  ...
  pgdetaildata.roomTypes.map((property, index) => (
            <li key={property.id}>
                            <span className="text-xs font-bold">{property.type} - ₹ {property.price}/day, Total Available-{property.availability} </span>

              <span style={{marginLeft:4}} onClick={() => handleBookNow(property)} className="time st-close cursor-pointer">
  Book Now
</span>
    ...
    {isLoading ? 'Enquiry...' : 'Enquire Now'}
        ...
        <div className="widget contact-info-widget mb-30 wow fadeInUp">
          <div className="contact-info-widget-wrap">
            ...
            <iframe
  src={`https://www.google.com/maps/embed/v1/place?q=${encodeURIComponent(pgdetaildata.location)}&key=AIzaSyB6gEq59Ly20DUl7dEhHW9KgnaZy4HrkqQ`}
  width="600"
  height="450"
  style={{ border: 0 }}
  allowFullScreen=""
