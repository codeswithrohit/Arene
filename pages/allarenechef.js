...
console.log("chefdata",fetchedData)
...
const handleTenureChange = (e, id) => {
  ...
  {/* <div className="mr-auto text-red-600 text-xs capitalize font-medium truncate">
      ...
      <span className="flex absolute h-2 w-2 top-0 right-0 -mt-1 -mr-1">
        ...
        <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
              ...
              <div className="items-center bg-white p-2 rounded-lg justify-center flex gap-1 font-medium text-[#10b981] dark:text-[#10b981]">
                      ...
                      {item.selectedTenure && (
                        <div>
                          {item.Foodcharge && item.Foodcharge.filter(property => property.tenure === item.selectedTenure).map((filteredProperty, index) => (
                            <div key={index}>
