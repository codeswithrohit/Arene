  ...
  return (
    <div>
            ...
            <div className="col-lg-8">
              <div className="listing-details-wrapper listing-details-wrapper-two">
                  ...
                  <div className="row align-items-center">
                    <div className="col-md-8">
                      <div className="listing-info-content">
                        ...
                        <h3 className="title">{rentdetaildata.Propertyname}</h3>
                        <div className="listing-meta">
                          <ul>
                            <li>
                              <span>
                                <i className="ti-location-pin" />
                                {rentdetaildata.location}
                              </span>
                            </li>
                            <li>
                              <span>
                ...
                <div className="listing-content mb-30 wow fadeInUp">
                  <h3 className="title">{rentdetaildata.PGName}</h3>
                  <p>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12">
                      <div className="icon-box icon-box-one">
                        ...
                        <div className="flex info">
                          <h6>Wi-Fi</h6>
                          {rentdetaildata.wifi === 'Yes' ? <FaCheck className="text-green-500 ml-2" /> : <FaTimes className="text-red-500 ml-2" />}
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-12">
                      <div className="icon-box icon-box-one">
                        ...
                        <div className="flex info">
                          <h6>Aquaguard</h6>
                          {rentdetaildata.Aquaguard === 'Yes' ? <FaCheck className="text-green-500 ml-2" /> : <FaTimes className="text-red-500 ml-2" />}
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-12">
                      <div className="icon-box icon-box-one">
                        ...
                        <div className="flex info">
                          <h6>Laundry</h6>
                          {rentdetaildata.Laundry === 'Yes' ? <FaCheck className="text-green-500 ml-2" /> : <FaTimes className="text-red-500 ml-2" />}
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-12">
                      <div className="icon-box icon-box-one">
                        ...
                        <div className="flex info">
                          <h6>Food</h6>
                          {rentdetaildata.Food === 'Yes' ? <FaCheck className="text-green-500 ml-2" /> : <FaTimes className="text-red-500 ml-2" />}
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-12">
      ...
      <div className="widget business-hour-widget mb-30 wow fadeInUp">
          ...
          {rentdetaildata.propertytypes && Array.isArray(rentdetaildata.propertytypes) ? (
  rentdetaildata.propertytypes.map((property, index) => (
            <li key={property.id}>
    ...
    {isLoading ? 'Enquiry...' : 'Enquire Now'}
        ...
        <div className="widget contact-info-widget mb-30 wow fadeInUp">
          <div className="contact-info-widget-wrap">
            ...
            <iframe
  src={`https://www.google.com/maps/embed/v1/place?q=${encodeURIComponent(rentdetaildata.location)}&key=AIzaSyB6gEq59Ly20DUl7dEhHW9KgnaZy4HrkqQ`}
  width="600"
  height="450"
  style={{ border: 0 }}
  allowFullScreen=""
